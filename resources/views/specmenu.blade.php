    ...
    <section id="main">
        <div class="dimension">
            ...
            <div id="checkin" class="containerbuttons">
                <h1>DIREZIONE</h1>
                <form action="{{ route('getHolidays') }}" method="get">
                    <button type="submit">Gestione ferie</button>
                </form>
                <form action="{{ route('registerForm') }}" method="get">
                    <button type="submit">Registrazione dipendenti</button>
                </form>
            ...
            <div id="amministraInfo" class="containerbuttons">
